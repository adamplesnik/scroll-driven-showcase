  ...
  return (
    <div className="h-[200vh] min-h-screen bg-gradient-to-t from-slate-400 to-zinc-600 scope/trigger dark:from-zinc-700 dark:to-zinc-900">
      <div className="sticky top-0 mx-auto max-w-screen-sm px-8 py-24">
        <div className="sticky top-24 z-10 mb-4 min-h-52 animate-from-box-shadow-none rounded-lg bg-zinc-300/20 p-4 shadow-xl backdrop-blur timeline dark:bg-zinc-700/70">
          <img
            src={album}
            alt="Kind of Blue, album cover artwork"
            className="animate-list-hero-picture mb-8 max-h-[70vh] rounded-lg timeline"
          />
          <Header className="relative z-10 sm:animate-move-header sm:timeline sm:range/28vh_100%" />
        </div>
        <div className="flex animate-to-opacity-full flex-col gap-2 rounded-lg bg-zinc-300/20 p-4 opacity-0 shadow-xl backdrop-blur timeline range/30vh_40vh dark:bg-zinc-700/70">
          ...
          <p className="my-8">
            Kind of Blue is regarded by many critics as Davis's masterpiece, the greatest jazz album
            ever recorded, and one of the best albums of all time. Its impact on music, including
            jazz, rock, and classical genres, has led writers to also deem it one of the most
